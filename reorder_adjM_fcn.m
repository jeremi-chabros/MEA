function reorder_adjM_fcn(files)
...
%}
%clear all
%files = dir('*SMPT*2B*adjM*.mat');  % make sure all the spike matrix files in the 
...
for i=1:length(files)
    ...
    %R script coord variable is in below order; however, I checked and can
    %confirm above order is correct 
    %{
...
%% plot adjM as it should look in R
%load('SMPT190923_2B_DIV21_cSpikes_L0.1254_adjM_reord.mat')
